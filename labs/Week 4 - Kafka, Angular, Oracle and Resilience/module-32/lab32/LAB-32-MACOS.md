...
| Evidence / screenshots | `~/java-bootcamp/notes/screenshots/lab-32` |
...
mkdir -p notes/screenshots/lab-32
...
Save under `~/java-bootcamp/notes/screenshots/lab-32`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets.
...
| 5 | Screenshots (if required) under `notes/screenshots/lab-32/` | Pass / Fail |
