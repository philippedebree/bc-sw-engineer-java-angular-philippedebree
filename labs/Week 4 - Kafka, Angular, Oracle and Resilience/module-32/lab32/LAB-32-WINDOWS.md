...
New-Item -ItemType Directory -Force -Path notes\screenshots\lab-32 | Out-Null
...
Save under `%USERPROFILE%\java-bootcamp\notes\screenshots\lab-32`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets.
