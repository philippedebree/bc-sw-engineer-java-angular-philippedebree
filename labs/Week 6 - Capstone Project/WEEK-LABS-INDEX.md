...
> **Java & Angular Fullstack.** Labs **48–52 are authored** for Angular + REST + **PostgreSQL** + OpenShift + GitHub Actions. Company-shareable brief/rubric: [Java_Angular_Fullstack_Capstone.docx](Java_Angular_Fullstack_Capstone.docx) · [Java_Angular_Fullstack_Capstone_Rubric.docx](Java_Angular_Fullstack_Capstone_Rubric.docx).
...
| **Capstone evaluation rubric (DOCX)** | [Java_Angular_Fullstack_Capstone_Rubric.docx](Java_Angular_Fullstack_Capstone_Rubric.docx) |
