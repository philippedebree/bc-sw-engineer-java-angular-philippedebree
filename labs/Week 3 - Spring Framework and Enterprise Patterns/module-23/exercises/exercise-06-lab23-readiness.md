...
- No REST-hosting / Security detour planned
...
From `examples/module-23-exercises/`, create `notes/` if needed, then create `notes/lab23-readiness.md`.
...
| notes/starters.md | _____ |
| notes/health-sketch.md | _____ |
