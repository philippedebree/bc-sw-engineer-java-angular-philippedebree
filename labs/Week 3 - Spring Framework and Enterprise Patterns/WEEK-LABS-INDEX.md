...
**Range:** lab22–lab29  
**Theme:** Spring IoC, Boot, REST MVC, layers, profiles, transactions, security, validation

**Authored for this course:** Lab 24 (Spring MVC REST endpoints). Other Week 3 labs are reused from JSE.
...
**Kahoot:** Modules 22–29 — instructor imports `Kahoot_Module_N.xlsx` from the authoring `kahoot/week-N/` folder; students join at [kahoot.it](https://kahoot.it).
