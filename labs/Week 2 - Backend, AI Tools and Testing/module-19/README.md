...
| C | Graded lab | [`lab19/LAB-19-GUIDE.md`](lab19/LAB-19-GUIDE.md) — timed path [`lab19/starter/`](lab19/starter/README.md) (~45 min) |
| D | Done | Mark Pass/Fail · Kahoot if scheduled |

**Graded project:** `examples/lab19-crm/` — Spring Boot `@SpringBootTest` / MockMvc, PostgreSQL test strategy, Selenium against **Angular**, GitHub Actions headless notes.
