...
New-Item -ItemType Directory -Force -Path notes\screenshots\lab-47 | Out-Null
...
Save under `%USERPROFILE%\java-bootcamp\notes\screenshots\lab-47`. Capture IntelliJ (project tree + editor). Redact secrets.
