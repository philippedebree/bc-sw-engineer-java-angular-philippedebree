...
grep -nE '1\.4\.0|CUS-1001|Sev-2|lab-request-001' communications/*.md
```

Markdown-only timed path — no Maven, Docker, or `kubectl`.
...
Save under `~/java-bootcamp/notes/screenshots/lab-47`. Capture IntelliJ (project tree + editor). Redact secrets.
