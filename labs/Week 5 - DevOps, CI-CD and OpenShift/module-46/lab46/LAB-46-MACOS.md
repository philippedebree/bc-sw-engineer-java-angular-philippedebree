...
Save under `~/java-bootcamp/notes/screenshots/lab-46`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets. Synthetic fixtures only (`CUS-1001` / `CUS-1002`).
...
| 5 | Screenshots (if required) under `notes/screenshots/lab-46/` | Pass / Fail |
