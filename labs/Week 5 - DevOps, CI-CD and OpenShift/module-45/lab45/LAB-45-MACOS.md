...
Save under `~/java-bootcamp/notes/screenshots/lab-45`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets. Never commit `*.tfstate` or real `terraform.tfvars`.
